...
SECRET_KEY = 'django-insecure-*#ffn*x0dr5of0+d!56jaag(r0!=r_-_$i&8n(zrh7@dt5sv#$'
...
import os  # 👈 ajoute cette ligne en haut du fichier si elle n’existe pas

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Répertoire global pour les templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
#Autoriser le frontend Angular à accéder à l’API
